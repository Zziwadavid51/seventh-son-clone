...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('𝐓𝐑𝐀𝐍𝐒𝐋𝐀𝐓𝐄𝐃 ➰🇺🇬', url="t.me/ugmoviesnow")
                 ],[
                    InlineKeyboardButton("🌀 𝐀𝐃𝐌𝐈𝐍 🎴", url="t.me/mrrighteous99")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Support Group', url="https://t.me/blastwallztv"),
            InlineKeyboardButton('Owner', url="https://t.me/mrrighteous99")
        ],[
